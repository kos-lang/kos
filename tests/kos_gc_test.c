...
static int verify_function(KOS_OBJ_ID obj_id)
{
    ...
    v = OBJPTR(FUNCTION, obj_id)->handler.bytecode;
    TEST( ! IS_BAD_PTR(v));
    TEST(GET_OBJ_TYPE(v) == OBJ_INTEGER);
                                 ...
                                 VERIFY_FUNC *verify)
{
    ...
    OBJPTR(FUNCTION, obj_id[0])->handler.bytecode = obj_id[1];
    ...
    OBJPTR(INTEGER, obj_id[5])->value = 52;
    OBJPTR(INTEGER, obj_id[6])->value = 53;
    OBJPTR(INTEGER, obj_id[7])->value = 54;
...
static int verify_class(KOS_OBJ_ID obj_id)
{
    ...
    TEST( ! IS_BAD_PTR(v));
    TEST(GET_OBJ_TYPE(v) == OBJ_INTEGER);
    TEST(OBJPTR(INTEGER, v)->value == 58);
                              ...
                              VERIFY_FUNC *verify)
{
    ...
    OBJPTR(CLASS, obj_id[0])->handler.bytecode = obj_id[1];
    ...
    OBJPTR(INTEGER, obj_id[5])->value = 56;
    OBJPTR(INTEGER, obj_id[6])->value = 57;
    OBJPTR(INTEGER, obj_id[7])->value = 58;

    KOS_atomic_write_relaxed_u32(OBJPTR(OBJECT_STORAGE, obj_id[8])->capacity,       1);
    KOS_atomic_write_relaxed_u32(OBJPTR(OBJECT_STORAGE, obj_id[8])->num_slots_used, 0);
    KOS_atomic_write_relaxed_u32(OBJPTR(OBJECT_STORAGE, obj_id[8])->num_slots_open, 0);
    KOS_atomic_write_relaxed_u32(OBJPTR(OBJECT_STORAGE, obj_id[8])->active_copies,  0);
    KOS_atomic_write_relaxed_ptr(OBJPTR(OBJECT_STORAGE, obj_id[8])->new_prop_table, KOS_BADPTR);
    KOS_atomic_write_relaxed_ptr(OBJPTR(OBJECT_STORAGE, obj_id[8])->items[0].key,   KOS_BADPTR);
    KOS_atomic_write_relaxed_ptr(OBJPTR(OBJECT_STORAGE, obj_id[8])->items[0].value, KOS_BADPTR);
...
static int verify_object_walk(KOS_OBJ_ID obj_id)
{
    ...
    v = OBJPTR(ITERATOR, obj_id)->prop_obj;
    TEST( ! IS_BAD_PTR(v));
    TEST(GET_OBJ_TYPE(v) == OBJ_INTEGER);
    ...
    v = OBJPTR(ITERATOR, obj_id)->returned_keys;
    TEST( ! IS_BAD_PTR(v));
    TEST(GET_OBJ_TYPE(v) == OBJ_INTEGER);
                                    ...
                                    VERIFY_FUNC *verify)
{
    ...
    OBJPTR(ITERATOR, obj_id[0])->prop_obj      = obj_id[2];
    OBJPTR(ITERATOR, obj_id[0])->key_table     = obj_id[3];
    OBJPTR(ITERATOR, obj_id[0])->returned_keys = obj_id[4];
    KOS_atomic_write_relaxed_u32(OBJPTR(ITERATOR, obj_id[0])->index,      58);
    KOS_atomic_write_relaxed_ptr(OBJPTR(ITERATOR, obj_id[0])->last_key,   obj_id[5]);
    KOS_atomic_write_relaxed_ptr(OBJPTR(ITERATOR, obj_id[0])->last_value, obj_id[6]);
    ...
    OBJPTR(INTEGER, obj_id[5])->value = 63;
    OBJPTR(INTEGER, obj_id[6])->value = 64;
...
#ifndef CONFIG_MAD_GC
        if (stats.num_objs_evacuated == base_stats.num_objs_evacuated) {
